...
## Setup
1. Register a domain in onecert. (ex: test.azure-test.net) Doc: https://eng.ms/docs/products/onecert-certificates-key-vault-and-dsms/onecert-customer-guide/docs 
